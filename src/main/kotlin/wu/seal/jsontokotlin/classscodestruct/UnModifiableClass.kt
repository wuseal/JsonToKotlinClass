...
abstract class UnModifiableClass : KotlinClass {
    ...
    override fun replaceReferencedClasses(referencedClasses: List<KotlinClass>): KotlinClass = throw UnsupportedOperationException("Dont support this function called on unModifiable Class")
}