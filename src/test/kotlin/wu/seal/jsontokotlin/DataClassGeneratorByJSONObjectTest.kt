    ...
    val json ="""
{
    ...
    fun generate() {
        ...
        val p1p2RefDataClass = p1p2.typeObject!!
        ...
        p1p2p1.type.should.be.equal(TYPE_STRING)
        p1p2p1.typeObject.should.be.`null`
        ...
        val p1p2p2RefDataClass = p1p2p2.typeObject!!
        ...
        val p1p2p2p1RefDataClass = p1p2p2p1.typeObject!!
        ...
        glossEntryP1.type.should.be.equal(TYPE_STRING)
        glossEntryP1.typeObject.should.be.`null`
        ...
        glossEntryP2.type.should.be.equal(TYPE_STRING)
        glossEntryP2.typeObject.should.be.`null`
        ...
        glossEntryP3.type.should.be.equal(TYPE_STRING)
        glossEntryP3.typeObject.should.be.`null`
        ...
        glossEntryP4.type.should.be.equal(TYPE_STRING)
        glossEntryP4.typeObject.should.be.`null`
        ...
        glossEntryP5.type.should.be.equal(TYPE_STRING)
        glossEntryP5.typeObject.should.be.`null`
        ...
        glossEntryP7.type.should.be.equal(TYPE_STRING)
        glossEntryP7.typeObject.should.be.`null`
        ...
        val glossDefDataClass = glossEntryP6.typeObject!!
        ...
        glossDefP1.type.should.be.equal(TYPE_STRING)
        glossDefP1.typeObject.should.be.`null`
